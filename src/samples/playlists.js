const playlists = {
  'one': {
    ...
    songs: [
      ...
      ['Karuppi', 'TAMIL', '2018', 'Santhosh Narayanan', '5IXdCWhQG78', 'Pariyerum Perumal', 0, 240],
      ...
      ['Aei Vennella Sona', 'TELUGU', '2001', 'Harris Jayaraj', 'UCDm1iR9y7Y', 'Cheli'],
      ['Going In Blind', 'ENGLISH', '2001', 'P.O.D', 'VH4YfGDild0', 'Greatest Hits: The Atlantic Years'],
      ['Kalalonaina', 'TELUGU', '2000', 'S.A.Raj Kumar', 'G1p3K-98iK4', 'Nuvvu Vasthavani'],
      ['Kabhi Neem Neem', 'HINDI', '2004', 'AR RAHMAN', 'ALQ7MLtEwtI', 'Yuva'],
